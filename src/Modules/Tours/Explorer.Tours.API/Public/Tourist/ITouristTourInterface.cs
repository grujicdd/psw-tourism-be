...
namespace Explorer.Tours.API.Public.Tourist
{
    ...
    {
        Result<PagedResult<TourDto>> GetPublishedTours(int page, int pageSize);
        Result<TourDto> GetTour(long id);
        Result<PagedResult<TourDto>> GetFilteredTours(int page, int pageSize, int? category, int? difficulty, decimal? maxPrice);
